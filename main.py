...
if __name__ == '__main__':
    ...
    while True:
        ...
        elif "how are you" in query or "are you fine" in query or "you are fine" in query:
            speak("i am fine and good how about you ?")
            speak("thank you for asking me!")

        if "i am fine jarvis" in query or "i am good" in query:
